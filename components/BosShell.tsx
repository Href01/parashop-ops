...
const sections: Array<{ label: string; items: NavItem[] }> = [
  ...
  },
  {
    label: 'Équipe',
    items: [
      { label: 'Espace de travail', href: '/work-hub', icon: Flame },
      { label: 'Espace collaboratif', href: '/workspace', icon: Users },
    ],
  },
  {
    label: 'Aide',
...
export default function BosShell({
  ...
  active: 'dashboard' | 'intelligence' | 'activity' | 'orders' | 'sendit' | 'products' | 'customers' | 'inventory' | 'prices' | 'leads' | 'restock' | 'campaigns' | 'ads' | 'events' | 'content' | 'work' | 'workspace' | 'guide' | 'settings'
  title: string
  crumb: string
  children: ReactNode
}) {
